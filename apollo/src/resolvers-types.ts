...
export type Game = {
  ...
  entitiesByRole?: Maybe<Array<Maybe<RoleList>>>;
...
export type Query = {
  ...
  findGamesJson?: Maybe<GameConnection>;
};
...
export type QueryFindGamesJsonArgs = {
  cursor: Scalars["String"]["input"];
};
...
export type ResolversTypes = ResolversObject<{
  ...
  GameJson: ResolverTypeWrapper<GameJson>;
...
> = ResolversObject<{
  ...
  description?: Resolver<
    ...
    ContextType
  >;
  entitiesByRole?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["RoleList"]>>>,
    ParentType,
    ContextType
  >;
...
export type GameJsonResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["GameJson"] = ResolversParentTypes["GameJson"],
> = ResolversObject<{
  description?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
...
> = ResolversObject<{
  ...
  >;
  findGamesJson?: Resolver<
    Maybe<ResolversTypes["GameConnection"]>,
    ParentType,
    ContextType,
    RequireFields<QueryFindGamesJsonArgs, "cursor">
  >;
}>;
...
export type RoleListResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["RoleList"] = ResolversParentTypes["RoleList"],
> = ResolversObject<{
  entities?: Resolver<
...
export type Resolvers<ContextType = any> = ResolversObject<{
  ...
  GameJson?: GameJsonResolvers<ContextType>;
